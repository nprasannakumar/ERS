...
public class FormStepDefs {
	...
	public void I_leave_the_as_empty_and_enter_suffix_as_firstName_as_lastName_as_phoneNumber_as_emailId_as_dob_as_and_gender_as(String missingField, String suffix, String firstName, String lastName, String phoneNumber, String email, String date, String gender) throws Throwable {
	...
	public void I_enter_related_values_to_fields_suffix_and_gender_and_valid_values_to_fields_firstName_lastName_phoneNo_email_date_and_submit_the_form(String suffix, String gender, String firstName,String lastName,String phoneNumber, String email, String date) throws Throwable {
		formPage.check_for_all_fields(suffix, firstName, lastName, phoneNumber, email, date, gender);
	}
